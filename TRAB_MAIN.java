...
public class TRAB_MAIN {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(TRAB_MAIN.class.getName()).log(Level.SEVERE, null, ex);
        }
...
class Philosopher extends Thread{
    ...
    private synchronized void releaseiBusy(){
        tray.setBusy(0);
    }
    
    private synchronized void setiBusy(){
        tray.setBusy(1);
    }
    ...
    private void eat(){
        ...
        if(this.bCanEat) {
            ...
            if(tray.getBusy() == 0){
            try {
                System.out.println("++++ Filósofo " + Integer.toString(iId) + " foi a bandeja");
                this.setiBusy();
                Thread.sleep(200);
                this.releaseiBusy();
                System.out.println("---- Filósofo " + Integer.toString(iId) + " saiu da bandeja");
                Thread.sleep(700);
                ...
                System.out.println("!!!!!!!!!!!Bandeja ocupada!!!!!!!!!!!!!");
            }          
        } 
    }
